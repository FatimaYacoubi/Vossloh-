           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td align="center">
                 ...
                 <h1 style="color: #ffd451; text-align: center;">Account Verified ${user.lastName}  </h1>
                 ...
                 <p style="color: #444444; font-size: 16px; text-align: justify;">Please follow the link below to complete the email verification process:</p>
                     <div style="text-align: center;">
                         <a href="${process.env.CLIENT_URL}/verify-email/${user.emailToken}"  style="color: #000000; background-color: #ffd451; padding: 12px 24px; display: inline-block; text-decoration: none; border-radius: 4px;">Verify your Email</a>
                     </div>
                 ...
                 <h3 style="color: #444444; font-size: 16px; text-align: justify;">The Vossloh Schwabe Team</p>
               </td>
             </tr>
           </table>
         </body>
                    ...
                    mailTransport().sendMail({
                      ...
                      html: `
                        <td align="center">
                          ...
                          <h1 style="color: #ffd451; text-align: center;"> ${user.lastName} Your Account Is Verified </h1>
                          <h3 style="color: #444444; font-size: 16px; text-align: justify;">Dear ${user.firstName},</p>
