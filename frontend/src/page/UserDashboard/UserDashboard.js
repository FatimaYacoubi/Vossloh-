    ...
    <div
      ...
      > 
       <div class="video-containerproductadd"> 
        <iframe width="500" height="340" src="https://www.youtube.com/embed/AYJneIrerdo?si=zmpDvjADjjRYaiDk" title="YouTube video player" frameborder="0" allowfullscreen loop mute ></iframe>
      </div>     
       <h3 className="library_trending_title">Create product  </h3>
 ...
 <div
          ...
          >
            ...
            <div className="library_album">
              <h1>Welcome Admin to Your User Dashboard!</h1>
