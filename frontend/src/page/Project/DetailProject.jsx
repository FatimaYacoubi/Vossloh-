...
const DetailProject = () => {
    ...
    const {data,loading,refetch,client} = useQuery(getProject,{variables:{
        id
      }})
  ...
  <div className="product1"> 
    ...
    {userInfo?.email===data?.project?.projectCreator.email&& <> <Button variant='light' className='btn-sm' onClick={() => {navigate(`/updateproject/${data?.project?.id}`)}}>
                     ...
                     onClick={() => {deleteproj(data?.project?.id);client.resetStore()}}
                     >
              ...
              <Form onSubmit={submitHandler}>
                <Form.Group controlId="comment">
                  ...
                  <Form.Control as='textarea' rows='3'
                   ...
                   <Button type="submit" style={{color:"orange",backgroundColor:"#00008B"}}> submit</Button>
              </Form>):""}
            </ListGroup.Item>  
